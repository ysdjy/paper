...
def test_status_and_no_authorization(pre):
    assert pre["status"] == "PREREGISTRATION_V4_BLOCK_STATE_SAMPLER_FROZEN_READY_FOR_C_REAUDIT"
...
def test_emitted_json_matches_module(tmp_path):
    ...
    assert j["status"] == "PREREGISTRATION_V4_BLOCK_STATE_SAMPLER_FROZEN_READY_FOR_C_REAUDIT"
