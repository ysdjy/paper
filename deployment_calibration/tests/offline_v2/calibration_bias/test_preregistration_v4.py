...
def test_status_and_no_authorization(pre):
    assert pre["status"] == "PREREGISTRATION_V4_FINAL_001_002_COMPLETION_READY_FOR_C_REGRESSION"
...
def test_emitted_json_matches_module(tmp_path):
    ...
    assert j["status"] == "PREREGISTRATION_V4_FINAL_001_002_COMPLETION_READY_FOR_C_REGRESSION"
