...
def test_status_and_no_authorization(pre):
    assert pre["status"] == "PREREGISTRATION_V4_BLOCK_STATE_KAT_GATE_READY_FOR_C_FINAL_REAUDIT"
...
def test_emitted_json_matches_module(tmp_path):
    ...
    assert j["status"] == "PREREGISTRATION_V4_BLOCK_STATE_KAT_GATE_READY_FOR_C_FINAL_REAUDIT"
