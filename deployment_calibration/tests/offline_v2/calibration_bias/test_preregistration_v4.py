...
def test_status_and_no_authorization(pre):
    assert pre["status"] == "PREREGISTRATION_V4_ONE_SHOT_BATCH_FIX_READY_FOR_FROZEN_ISSUE_REGRESSION"
...
def test_emitted_json_matches_module(tmp_path):
    ...
    assert j["status"] == "PREREGISTRATION_V4_ONE_SHOT_BATCH_FIX_READY_FOR_FROZEN_ISSUE_REGRESSION"
